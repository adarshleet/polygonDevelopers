...
export default function Footer() {
    ...
    <div className="grid gap-4 pb-4 text-left lg:pb-0 lg:grid-cols-3">
        ...
        <div>
            ...
            <div className="flex flex-col ">
                <Link className="py-1 hover:underline" href="https://www.instagram.com/polygon_developers?igsh=YjF6YjV4cmdiOTJx">Instagram</Link>
    ...
    <div className="pt-4 text-center border-t-2 lg:pt-0 lg:text-left lg:border-0 lg:pl-20 ">
        <p className="pb-4 text-xl font-semibold">GET IN TOUCH</p>
        <div className="space-y-2 text-gray-600">
            {/* <p>📍 123 Design Street, Interior City, India</p> */}
            <p>📞 +91 9037449895</p>
            <p>✉️ contact@polygondevelopers.com</p>
        </div>
        <p className="pt-4 text-gray-500">
            Have a project in mind? Let’s bring your dream space to life. Reach out to us today and let’s create something beautiful together.
        </p>
    </div>
</div>
            ...
            <div className="py-10 bg-zinc-200">
                <div className="container text-center text-gray-500 lg:justify-between lg:flex">
                    <div className="pb-4 lg:pb-0">
                        <p>&copy;2025 Polygon Developers rights reserved </p>
                    </div>
                    {/* <div className="">
