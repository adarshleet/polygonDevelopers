            ...
            <div className="container py-8 text-center lg:py-0 lg:text-left lg:flex lg:justify-between ">
                <div className="lg:w-1/2 xl:py-14 lg:py-8">
                    ...
                    <p className="pb-6 text-gray-500 xl:pb-10">
                        Transform your home into a masterpiece with timeless interiors. <br />
                        From cozy corners to grand living spaces, we design with passion <br />
                        and precision—bringing beauty, comfort, and harmony to every room.
                    </p>
