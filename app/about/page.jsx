            ...
            <div className="container ">
                <div className="py-4 lg:py-14">
                    ...
                    <p className="text-2xl font-medium lg:w-1/2">
                        Polygon Developers is a company specializing in interior design solutions for homes, offices, apartments, and more. We are dedicated to delivering modern, functional, and aesthetically pleasing spaces tailored to your needs. Our experienced team of interior design professionals ensures the highest quality and creativity in every project we undertake.
                    </p>
                </div>
                <div className="items-center lg:flex gap-x-8">
                    ...
                    <div className="">
                        <p className="pb-8 tracking-wide">
                            We are an international team of architects committed to redefining the future of architectural education and practice. At Polygon Developers, we believe it is essential to reimagine how architecture engages with society — integrating innovative ideas, creative methods, and modern tools for design, production, and communication.
                            <br />
                            <br />

                           We share a strong belief in the transformative power of collaboration — that when people unite with a common purpose, they can shape spaces that inspire, connect, and endure.
                            <br />
